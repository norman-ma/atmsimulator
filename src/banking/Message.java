...
public class Message
{
     ...
     * @param toNum the phone number which credits are to be transferred - can 
     *          be null if particular type of transaction does not have a credit transfer
     * @param credits the number of credits to be transferred - can 
     *          be -1 if particular type of transaction does not have a credit transfer 
    ...
    public Message(int messageCode, Card card, int pin, 
                   int serialNumber, int fromAccount, int toAccount, MobilePhoneNumber toNum, int credits, Money amount)
    {
     ...
     */
    public MobilePhoneNumber getNumber()
    {
        return number;
    }
    ...
    public static final int INQUIRY = 4;
     ...
     /** messageCode value for an top-up message
     */ 
    ...
    private MobilePhoneNumber number;
    private int credits;
}