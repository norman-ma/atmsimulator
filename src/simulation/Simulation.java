...
public class Simulation
{
    ...
    /** Read input in mobile number mode - allow user to enter several characters,
     *  and to clear the line if the user wishes; echo what use types
     */
    public static final int MOBILE_NUMBER_MODE = 4;
    
    /** Read input in number mode - allow user to enter several characters,
     *  and to clear the line if the user wishes; echo what use types
     */
    public static final int NUMBER_MODE = 5;
