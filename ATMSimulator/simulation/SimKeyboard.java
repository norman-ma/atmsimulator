...
class SimKeyboard extends Panel
{
            ...
            {           
                ...
                if (input.length() <= 4)
                    setEcho(input);
                        ...
                        setEcho(input.substring(0, input.length() - 4)+"-" + input.substring(input.length() - 4));                
                else
                    setEcho("("+ input.substring(0, input.length() - 7)+")"+input.substring(input.length() - 7, input.length() - 4)+"-" + input.substring(input.length() - 4));
                break;
            }
     ...
     *  and to clear the line if the user wishes; echo what use types
     */
    private static final int MOBILE_NUMBER_MODE = Simulation.MOBILE_NUMBER_MODE;
    
     /** Read input in amount mode - allow user to enter several characters,
     *  and to clear the line if the user wishes; echo what use types
     */
    private static final int NUMBER_MODE = Simulation.NUMBER_MODE;
